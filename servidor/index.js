...
// configurar para que utilice JSON
app.use(bodyParser.json());
app.use(bodyParser.urlencoded({extended:true}));
app.use(cors());

// valida webtoken valido
const jwtCheck = jwt({
      secret: jwks.expressJwtSecret({
          cache: true,
          rateLimit: true,
          jwksRequestsPerMinute: 5,
          jwksUri: 'https://victoruugo.eu.auth0.com/.well-known/jwks.json'
    }),
    audience: 'http://productos',
    issuer: 'https://victoruugo.eu.auth0.com/',
    algorithms: ['RS256']
});

// revisamos y validamos los scopes
const checkScope = jwtAuth([
    'read:productos'
]);
